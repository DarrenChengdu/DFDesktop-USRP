...
public:
    ...
    virtual bool OpenDevice() = 0;  // Yes
    virtual bool OpenDeviceWithSerial(int serialToOpen) = 0;  // No
    virtual int GetNativeDeviceType() const = 0;  // No
    virtual bool CloseDevice() = 0;  // Yes
