...
QT_MOC_LITERAL(1, 11, 12), // "setMarkerPos"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 18), // "handleSceneChanged"
QT_MOC_LITERAL(4, 44, 15) // "updateAllSeries"

    },
    "DataSource\0setMarkerPos\0\0handleSceneChanged\0"
    "updateAllSeries"
};
...
void DataSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setMarkerPos((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->handleSceneChanged(); break;
        case 2: _t->updateAllSeries(); break;
        default: ;
        }
    }
}
